export const seedData = [
  {
    PutRequest: {
      Item: {
        pk: { S: "COMPANY#0000000000000" },
        address: { S: "1234 Smallville USA" },
        annualRevenue: { S: "1000000" },
        companyName: { S: "Example Low Score" },
        ethicalScore: { N: "2" },
        website: { S: "https://www.ethicalconsumer.org/" }
      }
    }
  },
  {
    PutRequest: {
      Item: {
        pk: { S: "COMPANY#0000000000001" },
        address: { S: "2345 Medville USA" },
        annualRevenue: { S: "1000000" },
        companyName: { S: "Example Med Score" },
        ethicalScore: { N: "7" },
        website: { S: "https://www.ethicalconsumer.org/" }
      }
    }
  },
  {
    PutRequest: {
      Item: {
        pk: { S: "COMPANY#0000000000002" },
        address: { S: "3456 Largville USA" },
        annualRevenue: { S: "1000000" },
        companyName: { S: "Example High Score" },
        ethicalScore: { N: "15" },
        website: { S: "https://www.ethicalconsumer.org/" }
      }
    }
